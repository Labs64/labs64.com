...
This Privacy Policy has been generated by the Privacy Policy Generator of the [External Data Protection Officers](https://dg-datenschutz.de/services/external-data-protection-officer/?lang=en){:target="_blank"}{:rel="noopener nofollow"} that was developed in cooperation with RC GmbH, which sells [used notebooks](https://remarketing.company/){:target="_blank"}{:rel="noopener nofollow"} and the [Media Law Lawyers](https://www.wbs-law.de/eng/practice-areas/media-law/){:target="_blank"}{:rel="noopener nofollow"} from WBS-LAW.
